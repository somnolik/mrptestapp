...
mrptestapp stands for Digital (Scholarly) Editions Base Application. Its purpose is to bootstrap the development of (web) applications which support the process of
...
mrptestapp is a successor of the generic-de-web-app project described by the blog post series [How to build a digital edition web app](https://howto.acdh.oeaw.ac.at/blog/books/how-to-build-a-digital-edition-web-app/). While these blog posts were focused on describing general principles and basic implementations of a digital edition web app, mrptestapp should help you getting things done.
generic-de-web-app as well as mrptestapp are designed as (almost) self-containing eXist-db packages. Therefore you can
...
`git clone https://github.com/KONDE-AT/mrptestapp.git <folder-name>`

2. Run a search and replace through the whole codebase, replacing `mrptestapp` with e.g. the name of your application’s root directory. Since `mrptestapp` is used in several namespaces, make sure the replacement string does not contain any tricky characters.
